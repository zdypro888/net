...
type Entry struct {
	...
	Secure     bool      `bson:"secure" json:"secure" xorm:"secure bool" plist:"secure"`
	HttpOnly   bool      `bson:"httponly" json:"httponly" xorm:"httponly bool" plist:"httponly"`
	Persistent bool      `bson:"persistent" json:"persistent" xorm:"persistent bool" plist:"persistent"`
	HostOnly   bool      `bson:"hostonly" json:"hostonly" xorm:"hostonly bool" plist:"hostonly"`
	Expires    time.Time `bson:"expires" json:"expires" xorm:"expires datetime" plist:"expires"`
	Creation   time.Time `bson:"creation" json:"creation" xorm:"creation datetime" plist:"creation"`
	LastAccess time.Time `bson:"lastaccess" json:"lastaccess" xorm:"lastaccess datetime" plist:"lastaccess"`

	// SeqNum is a sequence number so that Cookies returns cookies in a
	// deterministic order, even for cookies that have equal Path length and
	// equal Creation time. This simplifies testing.
	SeqNum uint64 `bson:"seqnum" json:"seqnum" xorm:"seqnum int" plist:"seqnum"`
}
